...
export default function EmineTurk() {
    ...
    <>
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.nameRow}>
          <Image source={require('../assets/Icon/emine.png')} style={styles.avatarSmall} />
          <Text style={styles.name}>Emine Türk</Text>
        </View>

        {/* Bilgi Satırları */}
        <View style={styles.infoRow}>
          <FontAwesome name="envelope" size={16} color="#555" />
          <Text style={styles.infoText}>emineturk@gmail.com</Text>
        </View>
        <View style={styles.infoRow}>
          <FontAwesome name="university" size={16} color="#555" />
          <Text style={styles.infoText}>Hacettepe Üniversitesi</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            Merhaba! Ben Emine, Hacettepe Üniversitesi Fizik Mühendisliği 4. sınıf öğrencisiyim.
            Üniversite fizik derslerine olan ilgim sayesinde özellikle Mekanik I-II ve Elektrik konularında derinlemesine bilgi sahibiyim. 
            Son birkaç yıldır bu derslerde arkadaşlarıma sınav hazırlığı, konu tekrarları ve problem çözme tekniklerinde destek oluyorum.
            {'\n\n'}
            Karmaşık görünen konuları birlikte basitleştirerek anlamlı hale getirebiliriz. 
            Eğer fizik derslerinde zorlandığın noktalar varsa ya da birlikte örnek soru çözmek istersen, sana yardımcı olmaktan mutluluk duyarım.
            {'\n\n'}
            📚 Destek verebildiğim dersler: Mekanik I-II, Elektrik, Genel Fizik
            📅 Uygunluk: Hafta içi akşam saatleri ve hafta sonları
            {'\n\n'}
            “Fiziği anlamak zor değil; doğru yöntemle öğrenmek yeterli!”
          </Text>
        </View>
